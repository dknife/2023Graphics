...
class MyGLWidget(QOpenGLWidget):
    def __init__(self) :
        ...
        self.sunAngle = 0.
        self.earthRotation = 0.
        self.earthSpin = 0.
        self.moonRotation = 0.0
    ...
    def paintGL(self):
        ...
        glLoadIdentity()
        gluLookAt(0, 4, 10, 0, 0, -3, 0, 1, 0)

        self.sunAngle += 1.0
        self.earthRotation += 2.0
        self.earthSpin += 14.0
        self.moonRotation += 5.0
        ...
        # earth        
        glRotatef(-self.earthRotation, 0, 1, 0) ## 달에 영향을 미침
        glTranslatef(4, 0, 0)      ## 달에 영향의 미침
        glPushMatrix()
        glRotatef(self.earthSpin, 0, 1, 0)   ## 달에 영향을 미치지 않음
        glPushMatrix()
        ...
        # moon
        glRotatef(self.moonRotation, 0, 1, 0)
        glTranslatef(1, 0, 0)     
        glPushMatrix()
